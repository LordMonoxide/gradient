...
public class Tool extends GradientItemWorldTool {
  ...
  public Tool(final GradientTools.Type type, final GradientMetals.Metal metal) {
    super("tool." + type.cast.getRegistryName() + '.' + metal.name, metal.harvestSpeed, (float)(-4 + type.attackSpeed * metal.attackSpeedMultiplier), (int)(type.attackDamage * metal.attackDamageMultiplier), type.attackDurabilityLost, metal.durability);
    tools.add(this);
