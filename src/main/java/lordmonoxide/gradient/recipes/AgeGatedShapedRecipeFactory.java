...
public class AgeGatedShapedRecipeFactory implements IRecipeFactory {
  @Override
  public IRecipe parse(final JsonContext context, final JsonObject json) {
    ...
    return new AgeGatedShapedRecipe(group, age, pattern[0].length(), pattern.length, input, result);
  }
}
