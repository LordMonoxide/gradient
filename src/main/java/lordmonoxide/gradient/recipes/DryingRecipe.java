...
public class DryingRecipe implements IRecipe {
  ...
  public IRecipeSerializer<?> getSerializer() {
    return GradientRecipeSerializers.DRYING;
  }
  ...
  public static final class Serializer implements IRecipeSerializer<DryingRecipe> {
    ...
    @Override
    public DryingRecipe read(final ResourceLocation recipeId, final PacketBuffer buffer) {
      ...
      return new DryingRecipe(recipeId, group, age, ticks, output, inputs);
    }
