...
public class TerraConfig extends Placement<TerraPlacementConfig> {
  public static final TerraConfig INSTANCE = new TerraConfig(TerraPlacementConfig::deserialize);

  public TerraConfig(final Function<Dynamic<?>, ? extends TerraPlacementConfig> config) {
    super(config);
  }
