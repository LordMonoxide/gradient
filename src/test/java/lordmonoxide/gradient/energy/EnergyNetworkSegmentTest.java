...
class EnergyNetworkSegmentTest {
  ...
  void testMergingNetworks() {
    ...
    final EnergyNetworkSegment.EnergyNode originNode = net1.getNode(BlockPos.ORIGIN);
    final EnergyNetworkSegment.EnergyNode northNode = net1.getNode(BlockPos.ORIGIN.north());
    final EnergyNetworkSegment.EnergyNode southNode = net1.getNode(BlockPos.ORIGIN.south());
    final EnergyNetworkSegment.EnergyNode eastNode = net1.getNode(BlockPos.ORIGIN.east());
    final EnergyNetworkSegment.EnergyNode westNode = net1.getNode(BlockPos.ORIGIN.west());
    final EnergyNetworkSegment.EnergyNode source1Node = net1.getNode(BlockPos.ORIGIN.down());
    final EnergyNetworkSegment.EnergyNode origin2Node = net1.getNode(BlockPos.ORIGIN.up());
    final EnergyNetworkSegment.EnergyNode north2Node = net1.getNode(BlockPos.ORIGIN.up().north());
    final EnergyNetworkSegment.EnergyNode south2Node = net1.getNode(BlockPos.ORIGIN.up().south());
    final EnergyNetworkSegment.EnergyNode east2Node = net1.getNode(BlockPos.ORIGIN.up().east());
    final EnergyNetworkSegment.EnergyNode west2Node = net1.getNode(BlockPos.ORIGIN.up().west());
    final EnergyNetworkSegment.EnergyNode source2Node = net1.getNode(BlockPos.ORIGIN.up().up());
