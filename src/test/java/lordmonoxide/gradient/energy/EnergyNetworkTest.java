...
public class EnergyNetworkTest {
  ...
  @Test
  void testThisIsWeird() {
    GradientConfig.enet.enableNodeDebug = true;

    final TileEntity crank0x0x0 = this.world.addTileEntity(new BlockPos(0, 0, 0), TileEntityWithCapabilities.source(EnumFacing.UP));
    final TileEntity axle0x1x0 = this.world.addTileEntity(new BlockPos(0, 1, 0), TileEntityWithCapabilities.transfer(EnumFacing.UP, EnumFacing.DOWN));
    final TileEntity axle0x2x0 = this.world.addTileEntity(new BlockPos(0, 2, 0), TileEntityWithCapabilities.transfer(EnumFacing.UP, EnumFacing.DOWN));
    final TileEntity gear0x3x0 = this.world.addTileEntity(new BlockPos(0, 3, 0), TileEntityWithCapabilities.transfer());
    final TileEntity axle1x3x0 = this.world.addTileEntity(new BlockPos(1, 3, 0), TileEntityWithCapabilities.transfer(EnumFacing.EAST, EnumFacing.WEST));
    final TileEntity axle2x3x0 = this.world.addTileEntity(new BlockPos(2, 3, 0), TileEntityWithCapabilities.transfer(EnumFacing.EAST, EnumFacing.WEST));
    final TileEntity axle3x3x0 = this.world.addTileEntity(new BlockPos(3, 3, 0), TileEntityWithCapabilities.transfer(EnumFacing.EAST, EnumFacing.WEST));
    final TileEntity axle4x3x0 = this.world.addTileEntity(new BlockPos(4, 3, 0), TileEntityWithCapabilities.transfer(EnumFacing.EAST, EnumFacing.WEST));
    final TileEntity axle5x3x0 = this.world.addTileEntity(new BlockPos(5, 3, 0), TileEntityWithCapabilities.transfer(EnumFacing.EAST, EnumFacing.WEST));
    final TileEntity axle6x3x0 = this.world.addTileEntity(new BlockPos(6, 3, 0), TileEntityWithCapabilities.transfer(EnumFacing.EAST, EnumFacing.WEST));
    final TileEntity axle7x3x0 = this.world.addTileEntity(new BlockPos(7, 3, 0), TileEntityWithCapabilities.transfer(EnumFacing.EAST, EnumFacing.WEST));
    final TileEntity axle8x3x0 = this.world.addTileEntity(new BlockPos(8, 3, 0), TileEntityWithCapabilities.transfer(EnumFacing.EAST, EnumFacing.WEST));
    final TileEntity gear9x3x0 = this.world.addTileEntity(new BlockPos(9, 3, 0), TileEntityWithCapabilities.transfer());
    final TileEntity axle9x2x0 = this.world.addTileEntity(new BlockPos(9, 2, 0), TileEntityWithCapabilities.transfer(EnumFacing.UP, EnumFacing.DOWN));
    final TileEntity axle9x1x0 = this.world.addTileEntity(new BlockPos(9, 1, 0), TileEntityWithCapabilities.transfer(EnumFacing.UP, EnumFacing.DOWN));
    final TileEntity gear9x0x0 = this.world.addTileEntity(new BlockPos(9, 0, 0), TileEntityWithCapabilities.transfer());
    final TileEntity axle9x0x1 = this.world.addTileEntity(new BlockPos(9, 0, 1), TileEntityWithCapabilities.transfer(EnumFacing.NORTH, EnumFacing.SOUTH));
    final TileEntity sink9x0x2 = this.world.addTileEntity(new BlockPos(9, 0, 2), TileEntityWithCapabilities.sink());

    Assertions.assertEquals(1, this.network.connect(axle0x2x0.getPos(), axle0x2x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle0x2x0.getPos()).size());
    Assertions.assertEquals(1, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle1x3x0.getPos(), axle1x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle1x3x0.getPos()).size());
    Assertions.assertEquals(1, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle0x1x0.getPos(), axle0x1x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle0x1x0.getPos()).size());
    Assertions.assertEquals(1, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle2x3x0.getPos(), axle2x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle2x3x0.getPos()).size());
    Assertions.assertEquals(1, this.network.size());

    Assertions.assertEquals(1, this.network.connect(gear0x3x0.getPos(), gear0x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(gear0x3x0.getPos()).size());
    Assertions.assertEquals(1, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle5x3x0.getPos(), axle5x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle5x3x0.getPos()).size());
    Assertions.assertEquals(2, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle6x3x0.getPos(), axle6x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle6x3x0.getPos()).size());
    Assertions.assertEquals(2, this.network.size());

    Assertions.assertEquals(1, this.network.connect(gear9x3x0.getPos(), gear9x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(gear9x3x0.getPos()).size());
    Assertions.assertEquals(3, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle9x2x0.getPos(), axle9x2x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle9x2x0.getPos()).size());
    Assertions.assertEquals(3, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle7x3x0.getPos(), axle7x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle7x3x0.getPos()).size());
    Assertions.assertEquals(2, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle8x3x0.getPos(), axle8x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle8x3x0.getPos()).size());
    Assertions.assertEquals(2, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle9x0x1.getPos(), axle9x0x1).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle9x0x1.getPos()).size());
    Assertions.assertEquals(3, this.network.size());

    Assertions.assertEquals(1, this.network.connect(sink9x0x2.getPos(), sink9x0x2).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(sink9x0x2.getPos()).size());
    Assertions.assertEquals(3, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle9x1x0.getPos(), axle9x1x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle9x1x0.getPos()).size());
    Assertions.assertEquals(2, this.network.size());

    Assertions.assertEquals(1, this.network.connect(gear9x0x0.getPos(), gear9x0x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(gear9x0x0.getPos()).size());
    Assertions.assertEquals(2, this.network.size());

    Assertions.assertEquals(1, this.network.connect(crank0x0x0.getPos(), crank0x0x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(crank0x0x0.getPos()).size());
    Assertions.assertEquals(2, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle3x3x0.getPos(), axle3x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle3x3x0.getPos()).size());
    Assertions.assertEquals(1, this.network.size());

    Assertions.assertEquals(1, this.network.connect(axle4x3x0.getPos(), axle4x3x0).values().stream().distinct().count());
    Assertions.assertEquals(1, this.network.getNetworksForBlock(axle4x3x0.getPos()).size());
    Assertions.assertEquals(1, this.network.size());

    Assertions.assertEquals(1.0f, this.network.requestEnergy(sink9x0x2.getPos(), 1.0f));
  }
}
